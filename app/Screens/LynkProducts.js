        ...
        <SafeScreen>
            <View style={styles.container}>
                ...
                <View style={styles.btncontainer}>
                    ...
                    <ReButton color='linktextactive' title='Add to Catalog' iconname2='arrow-right' iconcolor2='whitecolor' width='70%' height={48} onPress={()=>navigation.navigate('CreateCatalog')}/>
                    <ReButton color='linktextactive' iconname='filter-variant' iconcolor='whitecolor' width={50} height={48} onPress={toggleModal} />
                </View>
